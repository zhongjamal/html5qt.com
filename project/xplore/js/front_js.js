	...
	$('#contents').fullpage({
		...
		afterLoad: function(anchorLink, index){
			if(index == '1'){
				...
				$('#dHead .btn-scroll a.down').delay(500).text('').addClass('active');
				$('#section0').find('.content h2').animate({top:0,opacity:1}, 800, 'easeInOutExpo');
				$('#section0').find('.content .txt').animate({top:0,opacity:0.8}, 800, 'easeInOutExpo');
				$('#section0').find('.content .btn-block').animate({top:0,opacity:1}, 800, 'easeInOutExpo');
			}

			if(index == '2'){
				$('#dHead .btn-scroll a.up').text('SmartGlobe Explorer AR');
				$('#dHead .btn-scroll a.down').text('ABOUT US');
				$('#section1').find('.content h2').animate({top:0,opacity:1}, 800, 'easeInOutExpo');
				$('#section1').find('.content .txt').animate({top:0,opacity:0.8}, 800, 'easeInOutExpo');
				$('#section1').find('.content .btn-block').animate({top:0,opacity:1}, 800, 'easeInOutExpo');
			}

			if(index == '3'){
				$('#dHead .btn-scroll a.up').text('SmartGlobe Adventure AR');
				$('#dHead .btn-scroll a.down').text('ABOUT US');
				$('#section2').find('.content h2').animate({left:0,opacity:1}, 800, 'easeInOutExpo');
				$('#section2').find('.content .txt').animate({left:0,opacity:0.8}, 800, 'easeInOutExpo');
				$('#section2').find('.content .btn-block').animate({top:0,opacity:1}, 800, 'easeInOutExpo');
			}

			if(index == '4'){
				$('#dHead .btn-scroll a.up').text('SmartGlobe Starry Globe');
				$('#dHead .btn-scroll a.down').text('MAP');
				$('#section3').find('.content h2').animate({top:0,left:0,opacity:1}, 800, 'easeInOutExpo');
				$('#section3').find('.content .txt').animate({top:0,left:0,opacity:0.8}, 800, 'easeInOutExpo');
			}

			if(index == '5'){
				$('#dHead .btn-scroll a.up').text('SmartGlobe Model');
		...
		onLeave: function(index, nextIndex, direction){
			if (index == 1 && direction == 'down'){
				...
				$('#dHead .btn-scroll a.up').text('').addClass('active');
			...
			if (index == 2 && direction == 'up'){
				...
				$('#section0').find('.content .btn-block').css({top:-500,opacity:0});
				$('#section0').find('.content .btn-block').stop().animate({top:0,opacity:1}, 1600, 'easeInOutExpo');
			...
			if (index == 4 && direction == 'up'){
				// $('#dHead .navi-bar img').delay(100).animate({marginTop:98}, 1200, 'easeInOutExpo');
				$('#dHead .btn-scroll a.up').text('').addClass('active');
				$('#dHead .btn-scroll a.down').text('').addClass('active');
				$('#section2').find('.content h2').css({left:-200,opacity:0});
				$('#section2').find('.content .txt').css({left:200,opacity:0});
				$('#section2').find('.content h2').stop().animate({left:0,opacity:1}, 1600, 'easeInOutExpo');
				$('#section2').find('.content .txt').stop().animate({left:0,opacity:0.5}, 1600, 'easeInOutExpo');
